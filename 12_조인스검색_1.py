...
f = open("c:\\work\\python220704\\land.txt", "wt", encoding="utf-8")
for n in range(1,10):
        #클리앙의 중고장터 주소  ### change
        ...
        data ='https://price.joinsland.joins.com/theme/index_theme.asp?CSRFToken=AXIsmOGJYjZucvbcmxDEamlELZIUsqPASigprsWK&sisaegbn=T05&areaCode=1138000000&searchgbn=&page=' + str(n)
        print (data)
        #웹브라우져 헤더 추가 
